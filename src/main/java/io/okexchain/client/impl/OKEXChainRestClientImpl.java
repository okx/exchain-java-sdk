...
public class OKEXChainRestClientImpl implements OKEXChainClient {

    private String backend;

    private static OKEXChainRestClientImpl oKEXChainClient;

    private OKEXChainRestClientImpl(String backend) {
        this.backend = backend;
    }

    public static OKEXChainClient getOKEXChainClient(String backend) throws NullPointerException {
        if (oKEXChainClient == null) {
            oKEXChainClient = new OKEXChainRestClientImpl(backend);
        }
