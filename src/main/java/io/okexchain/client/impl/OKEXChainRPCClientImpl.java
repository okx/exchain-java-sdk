package io.okexchain.client.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import io.okexchain.client.OKEXChainClient;
import io.okexchain.common.ConstantIF;
import io.okexchain.common.StrUtils;
import io.okexchain.common.jsonrpc.JSONRPCUtils;
import io.okexchain.crypto.Crypto;
import io.okexchain.crypto.keystore.CipherException;
import io.okexchain.crypto.keystore.KeyStoreUtils;
import io.okexchain.exception.InvalidFormatException;
...
import io.okexchain.types.staking.CommissionRates;
import io.okexchain.types.staking.Description;
...
public class OKEXChainRPCClientImpl implements OKEXChainClient {
    private String backend;

    private static OKEXChainRPCClientImpl oKEXChainRPCClientImpl;

    private OKEXChainRPCClientImpl(String backend) {
        this.backend = backend;
    }

    public static OKEXChainRPCClientImpl getOKEXChainClient(String backend) throws NullPointerException {
        if (oKEXChainRPCClientImpl == null) {
            oKEXChainRPCClientImpl = new OKEXChainRPCClientImpl(backend);
        }
        return oKEXChainRPCClientImpl;
    }
    ...
    public AccountInfo getAccountInfo(String privateKey) throws NullPointerException {
        ...
        try{
            ...
            throw new OKEXChainException("account not exist on OKEXChain");
        }
