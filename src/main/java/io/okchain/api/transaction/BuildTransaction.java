...
public class BuildTransaction {
    public static String generatePlaceOrderTransaction(OKChainClient okc,String side,String product,String price,String quantity, String sequence, String memo) {
    ...
    public static String generateCancelOrderTransaction(OKChainClient okc,String orderId, String sequence, String memo) {
        IMsg msg = new MsgCancelOrder(okc.userAddress,orderId);
        IMsg stdMsg = new MsgStd("order/cancel",msg);
        return buildTransaction(okc,stdMsg,msg,sequence,memo);
    }

    public static String generateSendTransaction(OKChainClient okc, String to, List<Token> amount, String sequence, String memo) {
