 ...
 * request item in the batch. Errors are always of type CosmosException.
 */
public class BatchResponse<T> {
    private Map<Integer, T> successesByIndex = new LinkedHashMap<>();
    private Map<Integer, CosmosException> errorsByIndex = new LinkedHashMap<>();
     ...
     */
    public BatchResponse(Map<Integer, T> successes, Map<Integer, CosmosException> errors) {
     ...
     * errors.
     */
    public List<CosmosException> errors() {
        List<CosmosException> res = new ArrayList<>();
     ...
     */
    public Map<Integer, CosmosException> errorsByIndex() {
