...
//        testDeListProposal();
    ...
    public static void testContractBlockedListProposal() {
        ...
        env.setChainID("okbchainevm-8");
        EnvInstance.getEnv().setRestServerUrl("http://localhost:8545");
        env.setDenom("okt");

//        {"codespace":"sdk","code":4,"gas_used":"67065","gas_wanted":"2000000","raw_log":"unauthorized: signature verification failed; verify correct account sequence and chain-id, sign msg:{\"account_number\":\"2\",\"chain_id\":\"okbchainevm-8\",\"fee\":{\"amount\":[{\"amount\":\"0.030000000000000000\",\"denom\":\"okt\"}],\"gas\":\"2000000\"},\"memo\":\"\",\"msgs\":[{\"type\":\"okbchain/gov/MsgSubmitProposal\",\"value\":{\"content\":{\"type\":\"okbchain/evm/ManageContractBlockedListProposal\",\"value\":{\"contract_addresses\":[\"okbchain1hw4r48aww06ldrfeuq2v438ujnl6alsz0685a0\",\"okbchain1qj5c07sm6jetjz8f509qtrxgh4psxkv32x0qas\"],\"description\":\"String description\",\"is_added\":true,\"title\":\"String title\"}},\"initial_deposit\":[{\"amount\":\"100.000000000000000000\",\"denom\":\"okt\"}],\"proposer\":\"okbchain1qpel9c5wlrc30efaskqfgzrda7h3sd745rcxeh\"}}],\"sequence\":\"9\"}","height":"0","txhash":"8240A3B7734DEB2878BD629CEB2426E04E1D4E96C3A3E7E87CB1933DD2FD0A49"}
        ...
        String[] contractAddresses = new String[]{"okbchain1hw4r48aww06ldrfeuq2v438ujnl6alsz0685a0","okbchain1qj5c07sm6jetjz8f509qtrxgh4psxkv32x0qas"};
    ...
    public static void testContractBlockedListProposalValue() {
        ...
        String[] distributorAddresses = new String[]{"okbchain1hw4r48aww06ldrfeuq2v438ujnl6alsz0685a0","okbchain1qj5c07sm6jetjz8f509qtrxgh4psxkv32x0qas"};
