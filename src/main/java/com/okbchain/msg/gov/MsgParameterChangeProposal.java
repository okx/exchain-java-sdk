...
import com.okbchain.msg.tx.Response;
...
public class MsgParameterChangeProposal extends MsgBase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JSONObject result = msg.submit(messages, "0.05000000", "500000", "okbchain change parameter proposal!");
...
//    @SneakyThrows
    public Message produceParameterChangeProposalMsg(
        ...
        content.setType("okbchain/params/ParameterChangeProposal");
