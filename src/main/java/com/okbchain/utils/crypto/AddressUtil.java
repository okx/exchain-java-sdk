...
import com.okbchain.utils.crypto.hash.Ripemd;
...
public class AddressUtil {
    ...
    public static String createNewAddressSecp256k1(String mainPrefix, byte[] publickKey){
        ...
        try {
            ...
            addressResult = com.okbchain.utils.crypto.encode.Bech32.encode(mainPrefix, bytes);
        } catch (Exception e) {
    ...
    public static String getPubkeyBech32FromValue(String mainPrefix, byte[] publickKeyValue) throws Exception {
        try {
            ...
            String pubBech32 = com.okbchain.utils.crypto.encode.Bech32.encode(mainPrefix, bytes);
            return pubBech32;
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
    ...
    public static String convertAddressFromValToBech32(String valAddress){
        ...
        try {
            ...
            bech32Address = com.okbchain.utils.crypto.encode.Bech32.encode(EnvInstance.getEnv().GetMainPrefix(), bytes);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
        return bech32Address;
    ...
    public static String convertAddressFromBech32ToVal(String bech32Address){
        ...
        try {
            ...
            valAddress = com.okbchain.utils.crypto.encode.Bech32.encode(EnvInstance.getEnv().GetValidatorAddrPrefix(), bytes);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
        return valAddress;
