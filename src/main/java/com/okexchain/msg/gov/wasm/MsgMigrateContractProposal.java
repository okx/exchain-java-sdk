...
public class MsgMigrateContractProposal extends MsgBase {
    ...
    public Message produceMsgMigrateContractProposal(String title,String description,String contract,int codeId,String msgJson,String denom, String amountDeposit){
        ...
        proposalValue.setContract(contract);
        proposalValue.setCodeId(codeId);
        proposalValue.setMsg(Utils.getSortJson(msgJson));
        return produceMsgMigrateContractProposal(proposalValue,denom, amountDeposit);
    }

    private Message produceMsgMigrateContractProposal(MsgMigrateContractProposalValue proposalValue,String denom, String amountDeposit){
